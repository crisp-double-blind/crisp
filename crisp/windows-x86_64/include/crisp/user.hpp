...
CRISP_API Eigen::Vector4f oklch(
...
CRISP_API std::unique_ptr<Model> make_model(Model::config_t const& cfg = {});
...
CRISP_API void register_uri_resolver(
  std::string_view scheme, uri_resolver_t&& resolver);
}  // namespace crisp
